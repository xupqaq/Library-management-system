...
<div class="formbody">
	...
	<form name="form1" action="addbook" method="post">
    <ul class="forminfo short">
        <li>
            <label>书名<b>*</b></label>
            <input  name="bookname" type="text" id="notnull1" value="" /><i id="notnul1"></i>
        </li>
        <li>
            <label>作者<b>*</b></label>
            <input  name="bookauthor" type="text" id="notnull2" value="" /><i id="notnul2"></i>
        </li>
        <li>
            <label>出版社<b>*</b></label>
            <input  name="bookpub" type="text" id="notnull3" value="" /><i id="notnul3"></i>
        </li>
        <li>
        ...
        <li>
            ...
            <input  name="booknum" type="text" id="notnull5" value="" /><i id="notnul5"></i>
        </li>
        <li>
            <label>书籍简介<b>*</b></label>
            <input  name="dec" type="text" id="notnull6" value="" /><i id="notnul6"></i>
        </li>
       
       
        <li style="width: 100%">
            <label>&nbsp;</label>
            <input id="btn2" onclick="submitform()" type="button" class="btn" value="确认添加"/>
        </li>
    </ul>
