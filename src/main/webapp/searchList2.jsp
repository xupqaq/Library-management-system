...
<form action="getAllBook" method="post">
    ...
    <table class="tablelist">
        ...
        <c:forEach items="${pageInfo.list }" var ="temp">
            <tr>
                ...
                <td><fmt:formatDate value="${temp.bookrecord }" pattern="yyyy-MM-dd"></fmt:formatDate></td>
                <td>${temp.booknum }</td>
                <td>
               	<a href="updatebook?bookid=${temp.bookid }" class="tablelink">修改</a>
                </td>
            </tr>
	</c:forEach>
        </tbody>
    ...
    <div class="pagin">
        ...
        <c:if test="${pageInfo.pageNum<=1 }">
         ...
         <c:if test="${pageInfo.pageNum>1 }">
        	<li class="paginItem"><a href="mngrAllBook?cpage=${pageInfo.pageNum-1 }"><span class="pagepre"></span></a></li>
        </c:if>
            ...
            <c:if test="${pageInfo.pages==pageInfo.pageNum }">
             ...
             <c:if test="${pageInfo.pages>pageInfo.pageNum }">
            	<li class="paginItem"><a href="mngrAllBook?cpage=${pageInfo.pageNum+1 }"><span class="pagenxt"></span></a></li>
            </c:if>
