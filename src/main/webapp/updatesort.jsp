...
<div class="formbody">
    ...
    <div class="formtitle"><span>修改图书类别</span></div>
    
	<form name="form1" action="updatesort1" method="post">
    <ul class="forminfo short">
        <li>
        	<input type="hidden" name="sortid" value="${bs.sortid }" />
            <label>图书类别名称<b>*</b></label>
            <input id="old1"  name="sortname" type="text" value="${bs.sortname }" /><i id="old"></i>
        </li>
